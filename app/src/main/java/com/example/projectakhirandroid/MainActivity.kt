...
import com.example.projectakhirandroid.adapter.KopiLiveAdapter
import com.example.projectakhirandroid.databinding.ActivityMainBinding
import com.example.projectakhirandroid.model.KopiLive
import com.example.projectakhirandroid.repository.KopiLiveData
...
class MainActivity : AppCompatActivity() {
    ...
    private var list: ArrayList<KopiLive> = arrayListOf()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        list.addAll(KopiLiveData.listData)

        mainBinding.rvKopiLive.layoutManager = LinearLayoutManager(this)
        val kopiLiveAdapter = KopiLiveAdapter(list)
        mainBinding.rvKopiLive.adapter = kopiLiveAdapter
